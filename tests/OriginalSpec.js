...
describe('Cursor', () => {
    ...
    it('can be value compared to a primitive', () => {
        let data = new Immutable.Map({ a: 'A' });
    ...
    it('updates with the return value of onChange', () => {
        ...
        onChange.and.returnValue(Immutable.fromJS({a: {b: {c: 11}}}));
    ...
    it('creates maps as necessary', () => {
        ...
        expect(cursor.deref()).toEqual(new Immutable.Map({d: 3}));
    });
    ...
    it('has the sequence API', () => {
        let data = new Immutable.Map({a: 1, b: 2, c: 3});
        let cursor = Cursor.from(data);
        expect(cursor.map((x) => x * x)).toEqual(new Immutable.Map({a: 1, b: 4, c: 9}));
    });
    ...
    it('can push values on a List', () => {
        ...
        expect(cursor.push(3, 4)).toEqual(new Immutable.List([0, 1, 2, 3, 4]));
        expect(onChange).toHaveBeenCalledWith(
            Immutable.fromJS({a: {b: [0, 1, 2, 3, 4]}}),
            data,
            new Immutable.Seq(['a', 'b'])
        );
    });
    ...
    it('can pop values of a List', () => {
        ...
        expect(cursor.pop()).toEqual(new Immutable.List([0, 1]));
        expect(onChange).toHaveBeenCalledWith(
    ...
    it('can unshift values on a List', () => {
        ...
        expect(cursor.unshift(-2, -1)).toEqual(new Immutable.List([-2, -1, 0, 1, 2]));
        expect(onChange).toHaveBeenCalledWith(
    ...
    it('can shift values of a List', () => {
        ...
        expect(cursor.shift()).toEqual(new Immutable.List([1, 2]));
        expect(onChange).toHaveBeenCalledWith(
