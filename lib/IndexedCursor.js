...
var IndexedCursor = (function (_Seq$Indexed) {
	function IndexedCursor(rootData, keyPath, onChange, size, api) {
	...
	_inherits(IndexedCursor, _Seq$Indexed);
	...
	_createClass(IndexedCursor, [{
		...
		value: function mergeDeep() {
			for (var _len6 = arguments.length, iterables = Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
		...
		value: function mergeDeepWith(merger) {
			for (var _len7 = arguments.length, iterables = Array(_len7 > 1 ? _len7 - 1 : 0), _key7 = 1; _key7 < _len7; _key7++) {
				iterables[_key7 - 1] = arguments[_key7];
			}
		...
		value: function mergeDeepIn(keyPath) {
			...
			for (var _len8 = arguments.length, iterables = Array(_len8 > 1 ? _len8 - 1 : 0), _key8 = 1; _key8 < _len8; _key8++) {
				iterables[_key8 - 1] = arguments[_key8];
			}
